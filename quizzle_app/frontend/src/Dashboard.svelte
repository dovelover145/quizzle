<script lang="ts">
  ...
  <div class="dashboard-container">
    <aside class="sidebar">
      <div class="sidebar-item create" on:click={() => (showCreateQuiz = true)}>
      ...
      <div class="sidebar-item active">
        <span class="icon">
          ...
          >
            ...
            <polyline points="9 22 9 12 15 12 15 22" /> <!--https://lucide.dev/icons/activity-->
          </svg>
        </span>
        <span class="text" on:click={() => (showCreateQuiz = false)} >Home</span>
      </div>
    ...
    <main class="main-content">
      {#if showCreateQuiz}
        <CreateQuiz on:close={() => (showCreateQuiz = false)} />
      {:else}
